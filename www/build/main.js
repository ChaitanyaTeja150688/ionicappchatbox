...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__chatbox_chatpage__ = __webpack_require__(304);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_chatbox_chatpage__ = __webpack_require__(304);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_list_list__ = __webpack_require__(229);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_pdf_pdf__ = __webpack_require__(228);
        ...
        for (var _i = 0, _a = this.selectionData; _i < _a.length; _i++) {
            ...
            if (item.type) {
                if (item.type != 'Quoted value') {
                    ...
                    var quoteOffereed = item.text === "$3000" ? '$150' : (item.text === "$5000" ? '$250' : '$450');
                    var total = item.text === "$3000" ? '$3150' : (item.text === "$5000" ? '$5250' : '$9450');
            ...
            if (response.result.action) {
                if (response.result.action.length > 0) {
                    if (response.result.action == "BusinessName") {
                        ...
                        var data = [{ text: '$ 3000' }, { text: '$ 5000' }, { text: '$ 9000' }];
