...
var ChatPage = (function () {
    function ChatPage(navCtrl, _http, speechRecognitionService) {
        ...
        this.url = 'http://ushydmehepatel7:8080';
        this.freeText = '';
        this.chatList = [];
